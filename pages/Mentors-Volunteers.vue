<!-- Page describing the mentorship and volunteer program -->
<template>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col">
        <h3>Mentors</h3>
        <PixelButton class="button" link="https://forms.gle/PLWLsNBp4SKrPbEN9" text="Mentor" img="purple-button-regular.svg" hover="purple on click.svg" click="purple visited.svg" />
      ...
      <div class="col">
        <h3>Volunteers</h3>
        <PixelButton class="button" link="https://docs.google.com/forms/d/e/1FAIpQLSd_w3VE7KB0Fo9dFD4qBeyRAijRqjpL6LWYtXaT51BTaEPKeA/viewform" text="Volunteer" img="purple-button-regular.svg" hover="purple on click.svg" click="purple visited.svg" />
        <p><b>Applications Closed!</b></p>
...
body {
  background-image: linear-gradient(#3c2137, #f4d2d9); /* Add the background gradient here */
...
.faq-row {
  display: flex;
  justify-content: center; /* Center the FAQ box horizontally */
  align-items: center; /* Center the FAQ box vertically */
}

.main-section {
  width: 100%; /* Ensure the FAQ section takes the full width */
}
